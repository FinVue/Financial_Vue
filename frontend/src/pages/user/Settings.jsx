...
function Settings() {
  ...
  return (
    ...
    <article className="p-6">
      <h3 className="text-heading-3 tracking-f-small font-bold text-white py-2">Settings</h3>
      <div onClick={handleSignOut} className="bg-zinc-800 cursor-pointer flex gap-3 p-4 w-full min-h-[60px] h-3/4 rounded-xl lg:grid-cols-10">
